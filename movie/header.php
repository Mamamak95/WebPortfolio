    ...
    <div class="center">
      ...
      <nav class="gnb">
        ...
        <div class="menu-list">
          ...
          <ul>
            <li><a href="./list.php?list=playing&page=1">현재 상영작</a></li>
            <li><a href="./list.php?list=popular&page=1">인기 영화</a></li>
            <li><a href="./list.php?list=upcoming&page=1">최신/개봉예정</a></li>
          </ul>
      </div>
        <a class="goto-search" href="./search.php"><i class="fa-solid fa-magnifying-glass-arrow-right"></i>검색하기</a>
      </nav>
    </div>
  </header>
  <button class="top-btn"><i class="fa-regular fa-hand-point-up"></i>
    <p>top</p>
  </button>